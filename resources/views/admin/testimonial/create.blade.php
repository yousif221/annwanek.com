                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <div class="form-material form-material-primary floating m-20">
                                        <label for="rew">Review Rating</label>
                                        <select id="rew" name="rating" class="form-control">
                            ...
                            <label class="col-12" for="review">Review</label>
                                    ...
                                    <div class="col-12">
                                        <textarea class="js-summernote" id="review" name="review"style="height:300px;">{{old('review')}}</textarea>
                                        </div>
                        ...
                        <div class="col-md-12">
                            <label class="mt-20">Testimonial Image</label>
                            ...
                            <div class="form-group row text-center">
                                ...
                                <div class="col-md-12">
                                <input type="submit" class="btn btn-primary m-30" value="Add Testimonial">
                            </div>
                                </div>
