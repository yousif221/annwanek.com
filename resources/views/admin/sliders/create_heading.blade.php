...
@section('content')
<div class="content">
    <h2 class="content-heading">Create New Heading <a href="{{route('admin.sliders.index')}}" class="btn btn-alt-primary pull-right">Back</a></h2>

    <form action="{{ route('admin.sliders.store_heading') }}" method="POST"enctype="multipart/form-data">
        @csrf
