...
@section('content')
    <div class="content">
        <h2 class="content-heading">Adding new Product <a href="{{route('admin.product.index')}}" class="btn btn-alt-primary pull-right">Back</a></h2>
                    ...
                    <div class="block block-rounded block-themed">
                        ...
                        <div class="block-content block-content-full">
                            ...
                            <!-- <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="type" name="type" placeholder="Product type" value="{{old('slug')}}">
                                    @if($errors->has('type'))
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <textarea class="form-control" name="short_description" placeholder="Short-Text description about Product" rows="8">{{ old('short_description') }}</textarea>
                            ...
                            <!-- <div class="form-group row">
                                <div class="col-md-12">
                                    <div class="block-content block-content-full p-0">
                                        ...
                                        <textarea name="detail" class="js-summernote">{{ old('detail') }}</textarea>
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <div class="block-content block-content-full p-0">
                                        ...
                                        <textarea name="additionalinfo" class="js-summernote">{{ old('additionalinfo') }}</textarea>
                            ...
                            <div class="row gutters-tiny items-push">
                                <div class="col-sm-12 col-xl-12">
                                    <div class="block">
                                        ...
                                        <label class="custom-file-label">Choose Product's Featured Image</label>
                                    </div>
                            ...
                            <div class="form-group row">
                                <div class="col-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" value="{{(old('selling_price'))?old('selling_price'):''}}" name="selling_price" placeholder="Product Selling Price">
                                    </div>
                            ...
                            <div class="form-group row">
                                <div class="col-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" value="{{(old('old_price'))?old('old_price'):''}}" name="old_price" placeholder="Product Selling Price">
                                    </div>
                                ...
                                <div class="col-12">
                                    <label>Stock</label>
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" name="stock" value="{{old('stock')}}"  placeholder="0">
                                        </div>
                                        @if($errors->has('stock'))
