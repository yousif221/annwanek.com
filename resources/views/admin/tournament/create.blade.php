...
@section('content')
    <div class="content">
        <h2 class="content-heading">Adding new Tournament <a href="{{route('admin.tournament.index')}}" class="btn btn-alt-primary pull-right">Back</a></h2>
        <form method="post" action="{{route('admin.tournament.store')}}" enctype="multipart/form-data">
            <div class="row gutters-tiny">
                <div class="col-md-10">
                    <div class="block block-rounded block-themed">
                        <div class="block-header bg-gd-primary">
                            <h3 class="block-title">Tournament Information</h3>
                        </div>
                        <div class="block-content block-content-full">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" name="title" placeholder="Tournament Name" value="{{old('title')}}">
                                    @if($errors->has('title'))
    ...
    <div class="col-12 mt-3">
        ...
        <div class="col-12 input-group">
            ...
            <input type="date" class="form-control" value="{{ old('date') }}" name="date" placeholder="Tournament Date">
        </div>
        @if($errors->has('date'))
    ...
    <div class="col-12 mt-3">
        ...
        <div class="col-12 input-group">
            ...
            <input type="time" class="form-control" value="{{ old('start_time') }}" name="start_time" placeholder="Start Time">
        </div>
    ...
    <div class="col-12 mt-3">
        ...
        <div class="col-12 input-group">
            ...
            <input type="time" class="form-control" value="{{ old('end_time') }}" name="end_time" placeholder="End Time">
        </div>
                    ...
                    <div class="form-group row">
                                <div class="col-md-12">
                                    <div class=" block-content block-content-full p-0">
                                        ...
                                        <div class="col-12">
                                        <textarea name="short_description" class=" form-control"style="height:300px;">{{ old('short_description') }}</textarea>
                                        </div>
                            ...
                            <div class="row gutters-tiny items-push">
                                <div class="col-sm-12 col-xl-12">
                                    <div class="block">
                                        ...
                                        <label class="custom-file-label">Choose Tournament's Display Image</label>
                                    </div>
