...
@section('content')
    <div class="content">
        <h2 class="content-heading">Adding new Blogs <a href="{{route('admin.blog.index')}}" class="btn btn-alt-primary pull-right">Back</a></h2>
        <form method="post" action="{{route('admin.blog.store')}}" enctype="multipart/form-data">
            <div class="row gutters-tiny">
                <div class="col-md-10">
                    <div class="block block-rounded block-themed">
                        <div class="block-header bg-gd-primary">
                            <h3 class="block-title">Blogs Information</h3>
                        </div>
                        <div class="block-content block-content-full">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" name="title" placeholder="Blogs Name" value="{{old('title')}}">
                                    @if($errors->has('title'))
                    ...
                    <div class="form-group row">
                                <label class="col-12" for="categories">State</label>
                                <div class="col-12">
                                    <select class="js-select2 form-control" id="state" name="state" style="width: 100%;" data-placeholder="Choose  state">
                                        <option></option>
                                        @foreach($states as $state)
                                            <option {{(old('state') == $state->id)? 'selected="selected"': ''}} value="{{$state->id}}">{{$state->name}}</option>
                                        @endforeach
                                    </select>
                                    @if($errors->has('state'))
                            ...
                            <div class="row gutters-tiny items-push">
                                <div class="col-sm-12 col-xl-12">
                                    <div class="block">
                                        ...
                                        <label class="custom-file-label">Choose Blogs's Display Image</label>
                                    </div>
