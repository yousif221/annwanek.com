...
@section('content')
    ...
    <div class="content">
        ...
        <h2 class="content-heading">Distance Details</h2>
            ...
            <div class="block-content">
                ...
                <table class="table table-hover table-vcenter">
                    ...
                    <tr>
                        ...
                        <td colspan="7" class="text-center"><p class="text-uppercase m-20 font-weight-bold">You have not listed any Distance yet.</p></td>
