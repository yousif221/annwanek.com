...
@section('title', 'Add business Variant')
@section('before-css')
...
@section('content')
    <div class="content">
        <h2 class="content-heading">Adding Product Variation<a href="{{route('admin.business.index')}}" class="btn btn-alt-primary pull-right">Back</a></h2>
        <form method="post" action="{{route('admin.business.storeVariant',$business_details->id)}}" enctype="multipart/form-data">
   ...
   <!-- Attribute Type Dropdown -->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <input type="number" class="form-control" id="price" name="price" placeholder="price" value="{{(old('price'))}}"></input>
                                    @if($errors->has('price'))
